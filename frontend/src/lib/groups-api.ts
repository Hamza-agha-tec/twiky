...
export interface GroupMessage {
  ...
  created_at: string;
  sender?: { id: string; email?: string | null; fullname?: string | null; full_name?: string | null; username: string | null; avatar_url: string | null; sub_plan?: 'FREE' | 'PRO' | 'ENTERPRISE' | null };
}
