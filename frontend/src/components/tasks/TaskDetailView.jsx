        ...
        <Sheet open={isOpen} onOpenChange={onClose}>
            <SheetContent side="right" className="w-full sm:max-w-2xl p-0 border-l border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 overflow-hidden flex flex-col">
                                    ...
                                    {task.attachments?.map((att, idx) => (
                                        <div key={idx} className="flex items-center gap-2 p-2 rounded-lg bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-800">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                ...
                                                <a href={att.url} target="_blank" rel="noreferrer" className="text-[10px] text-blue-500 hover:underline">View</a>
                                            </div>
                                            <Button
                                                variant="ghost"
                                                size="icon"
                ...
                <div className="p-4 border-t border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/50 relative">
                    {replyTo && (
                        <div className="mb-2 px-3 py-2 bg-blue-50 dark:bg-blue-900/20 border-l-2 border-blue-500 flex items-center justify-between rounded-r-lg">
                            <span className="text-[11px] font-medium text-blue-600 dark:text-blue-400">
                                Replying to <span className="font-bold">Team Member</span>
                            </span>
                            <Button variant="ghost" size="icon" className="h-4 w-4 text-blue-500" onClick={() => setReplyTo(null)}>
                                <X className="w-3 h-3" />
                            </Button>
                        </div>
                    )}
                    ...
                    <div className="flex items-center gap-3 p-3 bg-white dark:bg-slate-950 rounded-lg border border-slate-200 dark:border-slate-800 focus-within:ring-2 focus-within:ring-blue-500/20">
                        <Avatar className="h-8 w-8 shrink-0">
                            <AvatarFallback className="bg-blue-500 text-white text-xs font-bold">ME</AvatarFallback>
                        </Avatar>
                        <Input
                        ...
                        <div className="flex items-center gap-1">
                            ...
                            <Button
                                ...
                                size="icon"
                                className="h-8 w-8 bg-blue-500 hover:bg-blue-600 disabled:opacity-50"
                            >
                ...
                <div className="bg-slate-50 dark:bg-slate-900/50 rounded-2xl p-3 inline-block max-w-full">
                    ...
                    <p className="text-sm text-slate-700 dark:text-slate-300 leading-relaxed whitespace-pre-wrap">
                        {comment.content.split(/(@\w+)/g).map((part, i) =>
                            part.startsWith('@')
                                ? <span key={i} className="text-blue-500 font-semibold cursor-pointer hover:underline">{part}</span>
                                : part
                        )}
                    </p>
                </div>
                ...
                <div className="flex items-center gap-3 mt-1.5 px-1">
                    ...
                    {!isReply && (
                        <button
                            ...
                            className="flex items-center gap-1 text-[11px] font-bold text-slate-400 hover:text-blue-500 transition-colors"
                        >
