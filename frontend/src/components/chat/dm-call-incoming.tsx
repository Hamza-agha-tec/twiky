  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="fixed top-5 left-1/2 z-50 -translate-x-1/2 w-[320px] rounded-2xl border border-border bg-popover shadow-2xl overflow-hidden"
      >
        <div className="flex flex-col items-center gap-3 px-5 py-5">
          <div className="relative">
            ...
            <span className="absolute -bottom-1 -right-1 flex h-5 w-5 items-center justify-center rounded-full bg-green-500">
              {type === 'video' ? <Video className="h-2.5 w-2.5 text-white" /> : <Phone className="h-2.5 w-2.5 text-white" />}
            </span>
          </div>
