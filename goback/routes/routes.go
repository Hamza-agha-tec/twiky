...
func SetupRoutes(e *echo.Echo) {
	...
	channelService := services.NewChannelService(db.DB)
	...
	collaborationService := services.NewCollaborationService(db.DB)
	messagingService := services.NewMessagingService(db.DB)
	...
	invitationService := services.NewInvitationService(db.DB)
