...
type DirectConversationWithUsers struct {
	ID          string         `json:"id" db:"id"`
	UserOne     *User          `json:"user_one" db:"user_one"`
	UserTwo     *User          `json:"user_two" db:"user_two"`
	LastMessage *DirectMessage `json:"last_message" db:"last_message"`
	CreatedAt   time.Time      `json:"created_at" db:"created_at"`
	UpdatedAt   time.Time      `json:"updated_at" db:"updated_at"`
}
